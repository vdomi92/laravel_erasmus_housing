...
<x-app-layout>
    <div class="card w-50 full-width-md larger-width-lg mx-auto mt-1 p-2">
        ...
        <div class="card-body mt-5">
            ...
            <form
                @if($housing->id)
                    action="{{ route('housings.update', ['id' => $housing->id]) }}"
                    method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_method" value="PATCH">
                @else
                    action="{{ route('housings.store') }}" method="POST" enctype="multipart/form-data">
                @endif
                @csrf
                <div class="d-flex align-items-center justify-between flex-wrap">
                    ...
                    <div class="w-50 full-width-md">
                        ...
                        <select id="country"
                                class="form-control pb-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500
                                 rounded-md shadow-sm"
                                name="country"
                                aria-label="country select input">
                    ...
                    <div class="w-50 full-width-md pl-1">
                        ...
                        <x-text-input id="zip"
                                      ...
                                      type="text" name="zip"
                                      :value="old('zip', $housing->zip)"
                                      required autocomplete="zip" />
                    ...
                    <div class="w-50 full-width-md pl-1">
                        ...
                        <x-text-input id="nr_of_slots"
                                      class="form-control pb-1"
                                      type="number"
                                      name="nr_of_slots"
                                      :value="old('nr_of_slots', $housing->nr_of_slots)"
                                      required autocomplete="nr_of_slots" />
                ...
                <div class="d-flex align-items-center justify-between flex-wrap">
                    ...
                    <div class="w-75 full-width-md">
                        ...
                        <x-text-input id="street"
                                      ...
                                      :value="old('street', $housing->street)"
                    ...
                    <div class="w-25 full-width-md pl-1">
                        ...
                        <x-text-input id="house_nr"
                                      class="form-control pb-1"
                                      type="text" name="house_nr"
                                      :value="old('house_nr', $housing->house_nr)"
                                      required autocomplete="house_nr" />
                ...
                <div>
                    <label class="form-label mt-3 block font-medium text-sm text-gray-700"
                ...
                @if($housing->id === null)
                    <div class="d-flex flex-col">
                        ...
                        <input type="file" id="image" class="w-100 pb-1" name="image" placeholder="Upload preview image" />
